...
export function LaunchIntro({reducedMotion}:{reducedMotion:boolean}) {
 ...
 return <div className="launch-intro" aria-hidden="true" onAnimationEnd={e=>{if(e.animationName==='intro-depart')setVisible(false);}}><div className="intro-emblem"><img src={mark} alt=""/><span>VeyDock</span><small>VDOCK</small></div></div>;
}
